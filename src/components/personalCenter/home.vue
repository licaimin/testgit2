              ...
              <div class="material">
                <el-form :model="materialData"  label-width="100px">
                  ...
                  <el-form-item label="手机号" class="program">
                    <el-input v-model="materialData.mobile" class="input"></el-input>
                  </el-form-item>
                  ...
                  <v-distpicker @el-selected="onSelected" :placeholders="placeholder"
  ...
  export default {
    ...
    methods:{
      ...
      recordData(){
        ...
        this.$axios({
          method: 'get',
          baseURL: '/api/favourite/'+ self.userId,
          params:{
    ...
    created:function () {
      ...
      this.userId = currentId || JSON.parse(this.getCookie('userData')).id;

      this.visitorFlag = JSON.parse(this.getCookie('userData')).id != this.userId;
      let self = this;
      this.recordData();
      this.getBaseInfo();
      // 取得当前用户id
